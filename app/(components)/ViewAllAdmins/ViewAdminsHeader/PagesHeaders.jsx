...
import ReusableSelectInput from "../AllAdminsTable/ReusableSelectInput/ReusableSelectInput";
  ...
  return (
    <div className={`flex items-center justify-between  h-full py-8 mt-5 responsive px-10 font-cairo `}>
      <div className="flex flex-col items-start justify-center gap-8">
        ...
        {searchFields}
        <div className="flex items-center justify-center whitespace-nowrap gap-3">
          <h1>فرز حسب الحالة</h1>
          <ReusableSelectInput
              label={""}
