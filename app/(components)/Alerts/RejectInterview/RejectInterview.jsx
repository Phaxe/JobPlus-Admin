...
const AcceptModal = ({ visible, onClose }) => {
...
const locale = useLocale()
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 ">
     ...
     <div>
     <h1 className="text-2xl font-semibold text-darkGray text-center">{a("RejectInterview")}</h1>
     </div>


        <div className="w-full">
        <button className="px-8 py-3 w-full col-span-2 mt-2 bg-red-500 text-white rounded-lg">
        {a("InterviewReject")}
          </button>
        </div>
        </div>
